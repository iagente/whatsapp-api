...
messageRouter.post('/downloadEncryptedMedia/:sessionId', [middleware.sessionNameValidation, middleware.sessionValidation], messageController.downloadEncryptedMedia)
